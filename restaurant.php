...
<div class="page-hero">
  <div class="page-hero-bg" style="background-image:url('<?= SITE_URL ?>/images/restaurant-hero.jpg')"></div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;">
      <div class="animate-on-scroll">
        <div class="section-title" style="text-align:start;margin-bottom:24px;">
          <div class="subtitle" style="justify-content:flex-start;"><?= $lang==='ar'?'تجربة طعام استثنائية':'An Exceptional Dining Experience'?></div>
          <h2><?= t('our_restaurant') ?></h2>
        </div>
        <p style="color:var(--gray);font-size:16px;line-height:1.9;margin-bottom:20px;"><?= t('restaurant_desc') ?></p>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:28px 0;">
          <div style="padding:16px;background:var(--dark-2);border:1px solid var(--border);border-radius:var(--radius-sm);">
            ...
            <span style="font-size:13px;color:var(--gray);">6:30 AM - 10:30 AM</span>
          </div>
          <div style="padding:16px;background:var(--dark-2);border:1px solid var(--border);border-radius:var(--radius-sm);">
            ...
            <span style="font-size:13px;color:var(--gray);">12:30 PM - 3:00 PM</span>
          </div>
          <div style="padding:16px;background:var(--dark-2);border:1px solid var(--border);border-radius:var(--radius-sm);">
            ...
            <span style="font-size:13px;color:var(--gray);">7:00 PM - 11:00 PM</span>
          </div>
          <div style="padding:16px;background:var(--dark-2);border:1px solid var(--border);border-radius:var(--radius-sm);">
            ...
            <span style="font-size:13px;color:var(--gray);">24 <?= $lang==='ar'?'ساعة':'Hours'?></span>
          </div>
        </div>
      ...
      <div class="animate-on-scroll">
        <img src="<?= SITE_URL ?>/images/restaurant.jpg" alt="<?= $lang==='ar'?'مطعم البستان':'Al Bustan Restaurant'?>" loading="lazy" style="width:100%;height:480px;object-fit:cover;border-radius:var(--radius);border:1px solid var(--border);">
      </div>
    </div>
  </div>
</section>
